    ...
    <div class="card shadow-sm border-0 p-4">
        <form action="/author/update/{{ $blog->id }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $blog->title) }}" placeholder="กรอกชื่อบทความ">
                @error('title')
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                ...
                <button type="submit" class="btn btn-primary my-3 fw-bold">💾 อัพเดท</button>
            </div>
        </form>
    </div>
</div>
